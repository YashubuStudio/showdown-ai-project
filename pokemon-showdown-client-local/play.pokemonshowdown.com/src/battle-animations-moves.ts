...
export const BattleMoveAnims: AnimTable = {
	...
	chillyreception: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${clientAssetBase}/fx/weather-hail.png')`, 750, 1, 800);
		},
	},
	sandstorm: {
		anim: BattleOtherAnims.dance.anim,
	...
	orderup: {
		anim(scene, [attacker, defender]) {
			const tatsugiriSprite = {
				url: `${clientAssetBase}/sprites/gen5/tatsugiri${['-droopy', '-stretchy', ''][Math.floor(Math.random() * 3)]}.png`,
				w: 96,
				h: 96,
			};
	...
	morningsun: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/weather-sunnyday.jpg')`, 700, 0.5);
			scene.showEffect('wisp', {
				x: attacker.x + 40,
				y: attacker.y - 40,
				z: attacker.z,
	...
	moonlight: {
		anim(scene, [attacker]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/bg-space.jpg')`, 800, 0.6);
	...
	lunarblessing: {
		anim(scene, [attacker, ...defenders]) {
			for (const defender of defenders) {
				scene.backgroundEffect(`url('${clientAssetBase}/fx/bg-space.jpg')`, 900, 0.6);
				scene.showEffect('moon', {
					x: attacker.x,
					y: attacker.y + 150,
					z: attacker.z,
	...
	cosmicpower: {
		anim(scene, [attacker]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/bg-space.jpg')`, 600, 0.6);
			scene.showEffect('wisp', {
				x: attacker.x + 40,
				y: attacker.y - 40,
				z: attacker.z,
	...
	seismictoss: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/bg-space.jpg')`, 500, 0.6, 300);
			scene.showEffect('wisp', {
				x: defender.x,
				y: defender.y + 10,
				z: defender.z,
	...
	meteormash: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/bg-space.jpg')`, 1000, 0.4);
			scene.showEffect(attacker.sp, {
	...
	psystrike: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/weather-psychicterrain.png')`, 950, 0.6);
			scene.showEffect('poisonwisp', {
				x: defender.x - 100,
				y: defender.y,
				z: defender.z,
	...
	wish: {
		anim(scene, [attacker]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/bg-space.jpg')`, 600, 0.4);
	...
	dracometeor: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/bg-space.jpg')`, 1100, 0.8);
			scene.showEffect('flareball', {
	...
	solarbeam: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${clientAssetBase}/fx/weather-sunnyday.jpg')`, 900, 0.5);
	...
	meteorbeam: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${clientAssetBase}/fx/weather-sandstorm.png')`, 900, 0.5);
	...
	sheercold: { // Reminder: Improve this later
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/sprites/gen6bgs/bg-icecave.jpg')`, 1000, 0.6);
			scene.showEffect('icicle', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
	...
	dragonascent: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/bg-space.jpg')`, 1000, 0.7);
			scene.showEffect('iceball', {
	...
	plasmafists: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/sprites/gen6bgs/bg-earthycave.jpg')`, 2000, 1);
	...
	collisioncourse: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/weather-sunnyday.jpg')`, 1300, 0.5);
			scene.showEffect(attacker.sp, {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	electrodrift: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/fx/weather-electricterrain.png')`, 1300, 0.5);
			scene.showEffect(attacker.sp, {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	oceanicoperetta: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${clientAssetBase}/fx/weather-raindance.jpg')`, 700, 0.2, 2000);
			scene.showEffect('iceball', {
				x: attacker.x,
				y: attacker.y + 120,
				z: attacker.z,
	...
	splinteredstormshards: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${clientAssetBase}/sprites/gen6bgs/bg-earthycave.jpg')`, 2700, 0.8, 300);
	...
	clangoroussoulblaze: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect(`url('${clientAssetBase}/sprites/gen6bgs/bg-earthycave.jpg')`, 2000, 0.7, 300);
	...
	searingsunrazesmash: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${clientAssetBase}/fx/weather-trickroom.png')`, 700, 1);
			scene.backgroundEffect(`url('${clientAssetBase}/fx/bg-space.jpg')`, 2500, 1, 700);
